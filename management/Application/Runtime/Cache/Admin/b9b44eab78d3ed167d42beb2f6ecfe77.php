...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/health/management/Application/index.php/Admin/HistoryVis/add/user_id/44/relative_id/13" name="fileUploadForm" enctype="multipart/form-data">
        ...
        <div class="field">
          <select id="relative_id" name="relative_id">
            ...
            <?php foreach ($relaData as $k => $v): ?>
              <option value="<?php echo $v['relative_id']; ?>"><?php echo $v['relative_name']; ?></option>
            <?php endforeach; ?>
          </select>
          <span class="tips">*</span>
        </div>
