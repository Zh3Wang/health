...
<body>
<!-- 搜索表单 -->
<form method="get" action="/healthSystem/management/Application/index.php/Admin/HistoryVis/listHis/user_id/1/relative_id/0" id="searchForm">
  <div class="panel admin-panel">
    <!-- <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong></div> -->
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="layui-btn layui-btn-primary" href="/healthSystem/management/Application/index.php/Admin/HistoryVis/add/user_id/<?php echo I('get.user_id'); ?>/relative_id/<?php echo I('get.relative_id'); ?>"><i class="layui-icon">&#xe654;</i> 添加</a> </li>
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="layui-btn layui-btn layui-btn-mini" href="/healthSystem/management/Application/index.php/Admin/HistoryVis/edit/seecase_id/<?php echo $v['seecase_id']; ?>/user_id/<?php echo $v['user_id']; ?>/relative_id/<?php echo I('get.relative_id'); ?>"><i class="layui-icon">&#xe642;</i> 修改</a> 
          <a class="layui-btn layui-btn-danger layui-btn-mini" href="/healthSystem/management/Application/index.php/Admin/HistoryVis/delete/seecase_id/<?php echo $v['seecase_id']; ?>/user_id/<?php echo I('get.user_id'); ?>/relative_id/<?php echo I('get.relative_id'); ?>"><i class="layui-icon">&#xe640;</i> 删除</a> 
          </div></td>
          <td colspan="0">
          	<!-- 详情页面 -->
...
function del(seecase_id,user_id,relative_id){
	if(confirm("您确定要删除吗?")){
		window.location="/healthSystem/management/Application/index.php/Admin/HistoryVis/delete/seecase_id/"+seecase_id+"/user_id/"+user_id+"/relative_id/"+relative_id;
	}
}
