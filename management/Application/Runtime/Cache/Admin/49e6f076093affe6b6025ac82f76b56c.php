...
<body>
<!-- 搜索表单 -->
<form method="get" action="/healthSystem/management/Application/index.php/Admin/Relative/listRela" id="searchForm">
  <div class="panel admin-panel">
    
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="layui-btn layui-btn-primary" href="/healthSystem/management/Application/index.php/Admin/Relative/add/user_id/<?php echo I('get.user_id'); ?>"><i class="layui-icon">&#xe654;</i> 添加</a> </li>
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="layui-btn layui-btn layui-btn-mini" style="cursor:pointer" href="/healthSystem/management/Application/index.php/Admin/Relative/edit/relative_id/<?php echo $v['relative_id']; ?>"><i class="layui-icon">&#xe642;</i>　修　改</a> 
          ...
          <a style="margin-right: 85px;margin-top: 5px" class="layui-btn layui-btn-normal layui-btn-mini" href="/healthSystem/management/Application/index.php/Admin/HistoryVis/listHis/user_id/<?php echo $v['user_id']; ?>/relative_id/<?php echo $v['relative_id']; ?>"><i class="layui-icon">&#xe63c;</i>历史就诊</a>
          </div></td>
        </tr>
    <?php endforeach; ?>
...
function del(relative_id){
	if(confirm("您确定要删除吗?")){
		window.location="/healthSystem/management/Application/index.php/Admin/Relative/delete/relative_id/"+relative_id;
	}
}
