...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/health/management/Application/index.php/Admin/Doctor/uploadExcel/hos_id/75" name="fileUploadForm" enctype="multipart/form-data">
