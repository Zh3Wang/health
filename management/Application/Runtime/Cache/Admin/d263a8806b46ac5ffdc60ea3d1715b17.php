...
<body>
<form method="post" action="/healthSystem/management/Application/index.php/Admin/Auth/listRule" id="listform">
...
<div id="ruleForm" style="display: none" class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/healthSystem/management/Application/index.php/Admin/Auth/addRule" name="fileUploadForm" enctype="multipart/form-data">
...
<div id="editRule" style="display: none" class="panel admin-panel">
    <div style="margin-left: 10px" class="body-content">
    <form method="post" class="form-x" action="/healthSystem/management/Application/index.php/Admin/Auth/editRule" name="fileUploadForm" enctype="multipart/form-data">
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location="/healthSystem/management/Application/index.php/Admin/Auth/delRule/id/"+id;
	}
}
