...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/healthSystem/management/Application/index.php/Admin/HistoryVis/edit/seecase_id/13/user_id/1/relative_id/0" name="fileUploadForm" enctype="multipart/form-data">
