...
<body>
<form method="post" action="/healthSystem/management/Application/index.php/Admin/Auth/listAdmin" id="listform">
  <div class="panel admin-panel">
    <!-- <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong></div> -->
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="layui-btn layui-btn-primary" href="/healthSystem/management/Application/index.php/Admin/Auth/addAdmin"> <i class="layui-icon">&#xe654;</i>  添加管理员</a></li>
      </ul>
    </div>
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="layui-btn layui-btn-primary" href="/healthSystem/management/Application/index.php/Admin/Auth/editAdmin/mg_id/<?php echo $v['mg_id']; ?>"><span class="icon-edit"></span> 修改</a>
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location="/healthSystem/management/Application/index.php/Admin/Auth/delAdmin/mg_id/"+id;
	}
}
