...
<body>
<form method="post" action="/healthSystem/management/Application/index.php/Admin/Department/listDep" id="listform">
  <div class="panel admin-panel">
    <!-- <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong></div> -->
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="layui-btn layui-btn-primary" href="/healthSystem/management/Application/index.php/Admin/Department/add"> <i class="layui-icon">&#xe654;</i>  添加科室</a></li>
      </ul>
    </div>
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="layui-btn layui-btn layui-btn-mini" href="/healthSystem/management/Application/index.php/Admin/Department/edit/dep_id/<?php echo $v['dep_id']; ?>"><i class="layui-icon">&#xe642;</i> 修改</a>
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location="/healthSystem/management/Application/index.php/Admin/Department/delete/dep_id/"+id;
	}
}
