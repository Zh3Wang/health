...
<script type="text/javascript" charset="utf-8" src="/healthSystem/management/Application/Public/Ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/healthSystem/management/Application/Public/Ueditor/ueditor.all.min.js"> </script>
<script type="text/javascript" charset="utf-8" src="/healthSystem/management/Application/Public/Ueditor/lang/zh-cn/zh-cn.js"></script>
<style type="text/css">
    .tips{
      color: red;
      line-height: 40px;
...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/healthSystem/management/Application/index.php/Admin/Hospital/uploadExcel" name="fileUploadForm" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          ...
          <div class="tipss">先下载表格，填好数据后上传<a href="/healthSystem/management/Application/Public/Excel/医院导入表格.xls">（下载）</a></div>
        </div>
      </div>
      <!-- 提交 -->
