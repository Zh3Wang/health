...
<body>
<form method="post" action="/healthSystem/management/Application/index.php/Admin/doctor/listDoc/hos_id/77" id="listform">
  <div class="panel admin-panel">
    <!-- <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong></div> -->
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-green icon-plus-square-o" href="/healthSystem/management/Application/index.php/Admin/Doctor/add/hos_id/<?php echo I('hos_id'); ?>"> 添加医生</a> 
        <a class="button border-green icon-plus-square-o" href="/healthSystem/management/Application/index.php/Admin/Doctor/uploadExcel/hos_id/<?php echo I('hos_id'); ?>"> 批量导入</a></li>
        <li>搜索：</li>
        <li>首页
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="button border-main" href="/healthSystem/management/Application/index.php/Admin/doctor/edit/doc_id/<?php echo $v['doc_id']; ?>/hos_id/<?php echo $v['hos_id']; ?>"><span class="icon-edit"></span> 修改</a> 
...
function del(doc_id,hos_id){
	if(confirm("您确定要删除吗?")){
		window.location="/healthSystem/management/Application/index.php/Admin/doctor/delete/doc_id/"+doc_id+"/hos_id/"+hos_id;
	}
}
