...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/health/management/Application/index.php/Admin/hospital/addDep/hos_id/53" name="fileUploadForm" enctype="multipart/form-data">
