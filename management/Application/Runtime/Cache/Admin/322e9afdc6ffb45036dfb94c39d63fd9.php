...
<body>
<form method="post" action="/healthSystem/management/Application/index.php/Admin/Hospital/listHos" id="listform">
  <div class="panel admin-panel">
    <!-- <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong></div> -->
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="layui-btn layui-btn-primary" href="/healthSystem/management/Application/index.php/Admin/Hospital/add"><i class="layui-icon">&#xe654;</i> 添加医院</a>
        <a class="layui-btn layui-btn-normal" href="/healthSystem/management/Application/index.php/Admin/Hospital/uploadExcel"><i class="fa fa-hand-o-right" aria-hidden="true"></i> 批量导入</a> </li>
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="layui-btn layui-btn layui-btn-mini" href="/healthSystem/management/Application/index.php/Admin/hospital/edit/id/<?php echo $v['hos_id']; ?>"><i class="layui-icon">&#xe642;</i> 修改</a>
          ...
          <div style="margin-right: 70px;margin-top: 5px" id="menu">
	        ...
	        <a class="layui-btn layui-btn-primary layui-btn-mini" style="cursor:pointer" href="/healthSystem/management/Application/index.php/Admin/hospital/listDep/hos_id/<?php echo $v['hos_id']; ?>"><i class="fa fa-medkit" aria-hidden="true"></i> 科室</a>
	        <a class="layui-btn layui-btn-primary layui-btn-mini" style="cursor:pointer" href="/healthSystem/management/Application/index.php/Admin/doctor/listDoc/hos_id/<?php echo $v['hos_id']; ?>"><i class="fa fa-user-md" aria-hidden="true"></i> 医生</a>
          </div>
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location="/healthSystem/management/Application/index.php/Admin/hospital/delete/id/"+id;
	}
}
...
function DelSelect(){
	...
	if (Checkbox){
		...
		window.location="/healthSystem/management/Application/index.php/Admin/hospital/delete/id/"+hos_id;
		//$("#listform").submit();		
	}
	else{
		alert("请选择您要删除的内容!");
