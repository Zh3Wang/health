...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/healthSystem/management/Application/index.php/Admin/hospital/edit/id/77" name="fileUploadForm" enctype="multipart/form-data">
