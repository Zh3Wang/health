...
<body>
<form method="post" action="/healthSystem/management/Application/index.php/Admin/feedback/listAnalyze" id="listform">
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <tr>
          ...
          <a class="button border-green" style="cursor:pointer" href="/healthSystem/management/Application/index.php/Admin/feedback/listAnalyze"><span class="icon-view-o"></span> 更新</a>
          </div></td>
        </tr>
      <tr>
      	<td colspan="8">
...
function del(feedb_id){
	if(confirm("您确定要删除吗?")){
		window.location="/healthSystem/management/Application/index.php/Admin/Feedback/delete/feedb_id/"+feedb_id;
	}
}
